module github.com/pmaxis/pmaxis/services/api
...
require (
	...
	github.com/pmaxis/pmaxis/libs/clickhouse-client v0.0.0
	...
	github.com/pmaxis/pmaxis/libs/postgres-client v0.0.0
