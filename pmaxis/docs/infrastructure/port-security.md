# PMAxis Port Security & Docker Networking

## Why Ports Are Locked Down

PMAxis runs 10 containers inside a private Docker network. Services like Redis,
...
| File | Change |
|------|--------|
| `pmaxis/.dockerignore` | Created — excludes `docs/`, `deployments/`, `*.md`, `.git`, secrets from Docker build context |
...
# e.g.  image: pmaxis-api:latest  →  image: pmaxis-api:fc0dd1c
